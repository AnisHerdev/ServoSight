...
def main_test():
    ...
    try:
        while True:
            ...
            # --- Take photo if peace sign is detected ---
            if peace_found and (time.time() - last_peace_time > 2):  # debounce, 2 seconds
            ...
            # --- Start/stop video if palm is detected ---
            if palm_found and (time.time() - last_palm_time > 2):   # debounce, 2 seconds
